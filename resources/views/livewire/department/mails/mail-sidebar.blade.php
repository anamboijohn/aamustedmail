<div>
    ...
    <div class="email-app-sidebar">
        ...
        <ul class="nav main-menu" role="tablist">
            <li class="nav-item">
                <a class="btn-primary btn-block btn-mail w-100" href="{{ route('department.compose-mail') }}">
                    <i class="fas fa-envelope me-2"></i> NEW MAIL
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('department.mail-inbox') }}">
                    <span class="title">
            ...
            <li>
                <a href="{{ route('department.mail-all') }}">
                    <span class="title">
            ...
            <li>
                <a href="{{ route('department.mail-sent') }}">
                    <span class="title">
            ...
            <li>
                <a href="{{ route('department.declined-mail') }}">
                    <span class="title">
