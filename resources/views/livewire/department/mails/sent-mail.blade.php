                    ...
                    <div class="email-left-aside">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @livewire('department.mails.mail-sidebar')
                                    ...
                                    @forelse ($mails as $mail)
                                        <div class="media">
                                            ...
                                            <div class="media-body d-flex">
                                                ...
                                                <div class="ml-10">
                                                    <a href="{{ route('department.mail-read', $mail) }}">
                                                        <i class="fas fa-eye text-secondary mr-2"></i>
                                                    </a>
                                                    @if ($mail->sender_id == auth()->id())
                                                        <a href="{{ route('department.mail-edit', $mail) }}">
                                                            <i class="fas fa-edit mr-2"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{ route('department.reject-mail', $mail) }}">
