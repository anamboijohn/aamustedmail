        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Departments Forms</li>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <form wire:submit.prevent="updateDepartment" autocomplete="off">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input wire:model.defer="state.password_confirmation" id="password_confirmation"
