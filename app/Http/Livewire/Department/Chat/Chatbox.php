...
class Chatbox extends Component
{
    ...
    public function  getListeners()
    {
        ...
        return [
            "echo-private:department.chat.{$auth_id},MessageSent" => 'broadcastedMessageReceived',
            "echo-private:department.chat.{$auth_id},MessageRead" => 'broadcastedMessageRead',
    ...
    {
        ///here 
        $this->emitTo('department.chat.chatlist', 'refresh');
        # code...
    ...
    {
        return view('livewire.department.chat.chatbox');
    }
}
