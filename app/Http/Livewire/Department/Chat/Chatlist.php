...
class Chatlist extends Component
{
    ...
    public function chatUserSelected(Conversation $conversation, $receiverId)
    {
        ...
        $this->emitTo('department.chat.chatbox', 'loadConversation', $this->selectedConversation, $receiverInstance);
        $this->emitTo('department.chat.send-message', 'updateSendMessage', $this->selectedConversation, $receiverInstance);
    ...
    {
        return view('livewire.department.chat.chatlist');
    }
}
