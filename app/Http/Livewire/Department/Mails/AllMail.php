...
class AllMail extends Component
{
    ...
    public function mount()
    {
        ...
        $this->mails = Mail::where('sender_id', $this->auth_id)
            ->orWhere('receiver_id', $this->auth_id)->orderBy('created_at', 'DESC')->get();
    ...
    {
        return view('livewire.department.mails.all-mail');
    }
}
