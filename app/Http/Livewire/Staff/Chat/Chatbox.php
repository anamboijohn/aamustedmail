...
class Chatbox extends Component
{
    ...
    public function  getListeners()
    {
        ...
        return [
            "echo-private:staff.chat.{$auth_id},MessageSent" => 'broadcastedMessageReceived',
            "echo-private:staff.chat.{$auth_id},MessageRead" => 'broadcastedMessageRead',
    ...
    {
        return view('livewire.staff.chat.chatbox');
    }
}
