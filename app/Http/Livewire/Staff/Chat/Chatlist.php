...
class Chatlist extends Component
{
    ...
    public function chatUserSelected(Conversation $conversation, $receiverId)
    {
        ...
        $this->emitTo('staff.chat.chatbox', 'loadConversation', $this->selectedConversation, $receiverInstance);
        $this->emitTo('staff.chat.send-message', 'updateSendMessage', $this->selectedConversation, $receiverInstance);
    ...
    {
        return view('livewire.staff.chat.chatlist');
    }
}
